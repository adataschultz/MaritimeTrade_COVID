...
fit
```
# Create ARMA and GARCH order for different forecast models
```{r}
...
# Create PDF to save
```{r}
pdf("D:/MaritimeTrade/Results/TimeSeries/Garch_Univariate/Simulations100/100 Simulated ARMA-GARCH 2010-2020 predictions and CIs.pdf", width = 10,
    height = 10 )
plot(x = tfull, y= bymonth$Metric_Tons[tfull], type = "l",xlim = xran, 
     xlab = "Months Since Jan 1 2010", ylab = "Monthly Metric Tonnage",
     main = "Simulated ARMA-GARCH 2010-2020 predictions and CIs")
...
# Create PDF to save
```{r}
pdf("D:/MaritimeTrade/Results/TimeSeries/Garch_Univariate/Simulations100/100 Simulated ARMA-GARCH 2010-2020 Aggregrated Monthly Predictions and CIs.pdf", 
    width = 10,height = 10)
plot(x = tfull, y= bymonth$Metric_Tons[tfull], type = "l",xlim = xran, 
     xlab = "Months Since Jan 1 2010", ylab = "Monthly Metric Tonnage",
     main = "Simulated ARMA-GARCH 2010-20 Aggregrated Predictions and CIs")
...
# Create PDF to save
```{r}
pdf("D:/MaritimeTrade/Results/TimeSeries/Garch_Univariate/Simulations100/100 Simulated ARMA-GARCH 2010-2019 Aggregrated Monthly predictions and CIs.pdf", width = 10,
    height = 10 )
plot(x = tfull, y= bymonth$Metric_Tons[tfull], type = "l",xlim = xran, 
     xlab = "Months Since Jan 1 2010", ylab = "Monthly Metric Tonnage",
...
# Create PDF to save
```{r}
pdf("D:/MaritimeTrade/Results/TimeSeries/Garch_Univariate/Simulations100/100 Simulated ARMA-GARCH 2010-2011 Aggregrated Monthly Predictions and CIs.pdf", width = 10,
    height = 10 )
plot(x = tfull, y= bymonth$Metric_Tons[tfull], type = "l",xlim = xran, 
     xlab = "Months Since Jan 1 2010", ylab = "Monthly Metric Tonnage",
     main = "Simulated ARMA-GARCH 2010-11 Aggregrated Predictions and CIs")
...
# Create PDF to save
```{r}
pdf("D:/MaritimeTrade/Results/TimeSeries/Garch_Univariate/Simulations100/100 Simulated ARMA-GARCH 2010-2012 Aggregrated Monthly Predictions and CIs.pdf", width = 10,
    height = 10)
plot(x = tfull, y= bymonth$Metric_Tons[tfull], type = "l",xlim = xran, 
     xlab = "Months Since Jan 1 2010", ylab = "Monthly Metric Tonnage",
     main = "Simulated ARMA-GARCH 2010-12 Aggregrated Predictions and CIs")
...
# Create PDF to save
```{r}
pdf("D:/MaritimeTrade/Results/TimeSeries/Garch_Univariate/Simulations100/100 Simulated ARMA-GARCH 2010-2013 Aggregrated Monthly Predictions and CIs.pdf", width = 10,
    height = 10 )
plot(x = tfull, y= bymonth$Metric_Tons[tfull], type = "l",xlim = xran, 
     xlab = "Months Since Jan 1 2010", ylab = "Monthly Metric Tonnage",
     main = "Simulated ARMA-GARCH 2010-13 Aggregrated Predictions and CIs")
...
# Create PDF to save
```{r}
pdf("D:/MaritimeTrade/Results/TimeSeries/Garch_Univariate/Simulations100/100 Simulated ARMA-GARCH 2010-2015 Aggregrated Monthly Predictions and CIs.pdf", width = 10,
    height = 10 )
plot(x = tfull, y= bymonth$Metric_Tons[tfull], type = "l",xlim = xran, 
     xlab = "Months Since Jan 1 2010", ylab = "Monthly Metric Tonnage",
     main = "Simulated ARMA-GARCH 2010-15 Aggregrated Predictions and CIs")
