...
# Set seed
seed_value = 42
os.environ['LightGBM_1920'] = str(seed_value)
...
out_file = 'LightGBM_HPO_1920_trials.csv'
...
# Access results
results = pd.read_csv('LightGBM_HPO_1920_trials.csv')
...
# Save model
Pkl_Filename = 'LightGBM_HPO_1920.pkl'  
...
# =============================================================================
# # To load saved model
# model = joblib.load('LightGBM_HPO_1920.pkl')
# print(model)
# =============================================================================
...
print('\nModel Metrics for LightGBM HPO 2019-2020')
...
bayes_params.to_csv('bayes_params_LightGBM_HPO_1920_300.csv', index=False)
...
with open(r'D:\MaritimeTrade\Models\ML\LightGBM\Hyperopt\Model_Explanations\best_bayes_1920_HPO_300_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode('UTF-8'))

# Open the stored feature weights HTML file
url = r'D:\MaritimeTrade\Models\ML\LightGBM\Hyperopt\Model_Explanations\best_bayes_1920_HPO_300_WeightsFeatures.htm'
...
with open(r'D:\MaritimeTrade\Models\ML\LightGBM\Hyperopt\Model_Explanations\best_bayes_1920_HPO_300_Prediction.htm',
          'wb') as f:
    f.write(html_obj2.data.encode('UTF-8'))

# Open the show prediction stored HTML file
url2 = r'D:\MaritimeTrade\Models\ML\LightGBM\Hyperopt\Model_Explanations\best_bayes_1920_HPO_300_Prediction.htm'
...
exp.to_csv('best_bayes_1920_HPO_300_WeightsExplain.csv', index=False)
...
out_file = 'LightGBM_GBDT_1920_trials.csv'
of_connection = open(out_file, 'w')
writer = csv.writer(of_connection)
...
# Access results
results = pd.read_csv('LightGBM_GBDT_1920_trials.csv')
...
# Save model
Pkl_Filename = 'LightGBM_HPO_GBDT_1920.pkl'  
...
# =============================================================================
# # To load saved model
# model = joblib.load('LightGBM_HPO_GBDT_1920.pkl')
# print(model)
# =============================================================================
...
print('\nModel Metrics for LightGBM GBDT HPO Train1920 Test1920')
print('MAE train: %.3f, test: %.3f' % (
        mean_absolute_error(y_train, y_train_pred),
        mean_absolute_error(y_test, y_test_pred)))
print('MSE train: %.3f, test: %.3f' % (
...
# Save dataframes of parameters
bayes_params.to_csv('bayes_params_LightGBM_HPO_GBDT_1920_300.csv', index=False)
...
# Write feature weights html object to a file 
with open(r'D:\MaritimeTrade\Models\ML\LightGBM\Hyperopt\Model_Explanations\best_bayes_1920_GBDT_300_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode('UTF-8'))

# Open the stored feature weights HTML file
url = r'D:\MaritimeTrade\Models\ML\LightGBM\Hyperopt\Model_Explanations\best_bayes_1920_GBDT_300_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write show prediction html object to a file 
with open(r'D:\MaritimeTrade\Models\ML\LightGBM\Hyperopt\Model_Explanations\best_bayes_1920_GBDT_300_Prediction.htm',
          'wb') as f:
    f.write(html_obj2.data.encode('UTF-8'))

# Open the show prediction stored HTML file
url2 = r'D:\MaritimeTrade\Models\ML\LightGBM\Hyperopt\Model_Explanations\best_bayes_1920_GBDT_300_Prediction.htm'
webbrowser.open(url2, new=2)
...
# Write processed data to csv
exp.to_csv('best_bayes_1920_GBDT_300_WeightsExplain.csv', index=False)
