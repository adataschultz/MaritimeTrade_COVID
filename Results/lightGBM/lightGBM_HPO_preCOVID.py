...
df = df.drop(['DateTime', 'Year', 'DateTime_YearWeek', 'Date_Weekly_COVID',
...
bayes_params.to_csv('bayes_paramslightGBM_HPO_GBDT_1019.csv', index = False)
...
bayes_params.to_csv('bayes_params_HPO_GBDT_preCOVID_300.csv', index = False)
