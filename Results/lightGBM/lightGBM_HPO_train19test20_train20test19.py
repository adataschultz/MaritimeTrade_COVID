...
def objective(params, n_folds = N_FOLDS):
    ...
    #best_score = np.min(cv_results['mae'])
...
with open(r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train19test19_HPO_300_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train19test19_HPO_300_WeightsFeatures.htm'
...
exp.to_csv('MaritimeTrade_best_bayes_train19test19_HPO_300_WeightsExplain.csv',
...
with open(r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train19test19_HPO_300_Prediction.htm',
          'wb') as f:
    f.write(html_obj2.data.encode("UTF-8"))

# Open the show prediction stored HTML file
url2 = r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train19test19_HPO_300_Prediction.htm'
...
# Write feature weights html object to a file 
with open(r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train19test20_HPO_300_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train19test20_HPO_300_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write processed data to csv
exp.to_csv('MaritimeTrade_best_bayes_train19test20_HPO_300_WeightsExplain.csv',
           index=False, encoding='utf-8-sig')
...
# Write show prediction html object to a file 
with open(r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train19test20_HPO_300_Prediction.htm',
          'wb') as f:
    f.write(html_obj2.data.encode("UTF-8"))

# Open the show prediction stored HTML file
url2 = r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train19test20_HPO_300_Prediction.htm'
webbrowser.open(url2, new=2)
...
# Write feature weights html object to a file 
with open(r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train20test20_HPO_300_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train20test20_HPO_300_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write processed data to csv
exp.to_csv('MaritimeTrade_best_bayes_train20test20_HPO_300_WeightsExplain.csv',
           index=False, encoding='utf-8-sig')
...
# Write show prediction html object to a file 
with open(r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train20test20_HPO_300_Prediction.htm',
          'wb') as f:
    f.write(html_obj2.data.encode("UTF-8"))

# Open the show prediction stored HTML file
url2 = r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train20test20_HPO_300_Prediction.htm'
webbrowser.open(url2, new=2)
...
# Write feature weights html object to a file 
with open(r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train20test19_HPO_300_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train20test19_HPO_300_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write processed data to csv
exp.to_csv('MaritimeTrade_best_bayes_train20test19_HPO_300_WeightsExplain.csv',
           index=False, encoding='utf-8-sig')
...
# Write show prediction html object to a file 
with open(r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train20test19_HPO_300_Prediction.htm',
          'wb') as f:
    f.write(html_obj2.data.encode("UTF-8"))

# Open the show prediction stored HTML file
url2 = r'D:\MaritimeTrade\Results\lightGBM\best_bayes_train20test19_HPO_300_Prediction.htm'
webbrowser.open(url2, new=2)
