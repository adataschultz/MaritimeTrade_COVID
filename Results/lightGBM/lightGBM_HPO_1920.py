...
with open(Pkl_Filename, 'wb') as file:  
    pickle.dump.dump(best_bayes_model, file)
...
bayes_params.to_csv('bayes_params_lightGBM_HPO_GBDT_1920.csv', index = False)
...
bayes_params.to_csv('bayes_params_HPO_GBDT_1920_300.csv', index = False)
...
i = 0
for i, hpo in enumerate(['learning_rate', 'num_leaves', 'bagging_frequency',
                         'feature_fraction']):
        # Scatterplot
...
# Show prediction
html_obj2 = show_prediction(best_bayes_model, X.iloc[1],
