...
df = df.drop(['DateTime', 'DateTime_YearWeek', 'Date_Weekly_COVID',
                ...
                'cases_pctdelta', 'deaths_pctdelta', 'State'], axis=1)
...
X_train = ce_ord.fit_transform(X_train, y_train)

# Testing set: Encode variables using ranking - ordinal               
ce_ord = ce.OrdinalEncoder(cols = ['foreign_company_size', 'us_company_size'])
X_test = ce_ord.fit_transform(X_test, y_test)
...
print('Bayes Optimization 100 trials boosting type percentages')
...
with open(r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_preCovid_HPO_100_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_preCovid_HPO_100_WeightsFeatures.htm'
...
with open(r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_preCovid_HPO_100_Prediction.htm',
          'wb') as f:
    f.write(html_obj2.data.encode("UTF-8"))

# Open the show prediction stored HTML file
url2 = r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_preCovid_HPO_100_Prediction.htm'
...
exp.to_csv('best_bayes_preCovid_HPO_100_WeightsExplain.csv',
...
# Save dataframes of parameters
bayes_params.to_csv('bayes_params_lightGBM_HPO_GBDT_preCOVID_300.csv', index = False)
...
# Write feature weights html object to a file 
with open(r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_preCOVID_GBDT_300_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_preCOVID_GBDT_300_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write show prediction html object to a file 
with open(r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_preCOVID_GBDT_300_Prediction.htm',
          'wb') as f:
    f.write(html_obj2.data.encode("UTF-8"))

# Open the show prediction stored HTML file
url2 = r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_preCOVID_GBDT_300_Prediction.htm'
webbrowser.open(url2, new=2)
...
# Write processed data to csv
exp.to_csv('best_bayes_preCOVID_GBDT_300_WeightsExplain.csv',
           index=False, encoding='utf-8-sig')
