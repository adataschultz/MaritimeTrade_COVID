...
with open(r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_1920_HPO_300_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_1920_HPO_300_WeightsFeatures.htm'
...
with open(r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_1920_HPO_300_Prediction.htm',
          'wb') as f:
    f.write(html_obj2.data.encode("UTF-8"))

# Open the show prediction stored HTML file
url2 = r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_1920_HPO_300_Prediction.htm'
...
exp.to_csv('best_bayes_1920_HPO_300_WeightsExplain.csv',
...
# Write feature weights html object to a file 
with open(r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_1920_GBDT_300_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_1920_GBDT_300_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write show prediction html object to a file 
with open(r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_1920_GBDT_300_Prediction.htm',
          'wb') as f:
    f.write(html_obj2.data.encode("UTF-8"))

# Open the show prediction stored HTML file
url2 = r'D:\MaritimeTrade\ML\lightGBM\Model_Explanations\best_bayes_1920_GBDT_300_Prediction.htm'
webbrowser.open(url2, new=2)
...
# Write processed data to csv
exp.to_csv('best_bayes_1920_GBDT_300_WeightsExplain.csv',
           index=False, encoding='utf-8-sig')
